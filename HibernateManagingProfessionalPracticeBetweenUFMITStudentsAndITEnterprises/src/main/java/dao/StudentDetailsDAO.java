...
public class StudentDetailsDAO implements DAOInterface<StudentDetails> {

	public static StudentDetailsDAO getInstance()//SinhVienDAO.getInstance() instead of SinhVienDAO s = new SinhVienDAO(); s.getInstance();.
	{
		return new StudentDetailsDAO();
	}
	
	@Override
	public boolean insert(StudentDetails t) {
		try {
	...
	@Override
	public boolean update(StudentDetails t) {
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
			{
	...
	@Override
	public boolean delete(StudentDetails t) {
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
			{
	...
	@Override
	public StudentDetails selectById(StudentDetails t) {
		List<StudentDetails> list = new ArrayList();
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
			{
				...
				String hql = "from StudentDetails where id = :id";
