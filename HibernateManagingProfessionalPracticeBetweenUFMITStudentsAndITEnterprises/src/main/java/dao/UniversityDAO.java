...
public class UniversityDAO implements DAOInterface<University> {
	...
	public static UniversityDAO getInstance()//SinhVienDAO.getInstance() instead of SinhVienDAO s = new SinhVienDAO(); s.getInstance();.
	{
		return new UniversityDAO();
	}
	
	@Override
	public boolean insert(University t) {
		try {
	...
	@Override
	public boolean update(University t) {
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
			{
	...
	@Override
	public boolean delete(University t) {
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
			{
	...
	@Override
	public University selectById(University t) {
		List<University> list = new ArrayList();
		try {
			SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
			if(sessionFactory!=null)
