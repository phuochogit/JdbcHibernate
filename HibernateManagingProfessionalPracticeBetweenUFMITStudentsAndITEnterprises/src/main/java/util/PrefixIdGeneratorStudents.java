...
public class PrefixIdGeneratorStudents implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        Integer maxId = (Integer) session.createQuery("select coalesce(max(id), :prefix) from Students")
