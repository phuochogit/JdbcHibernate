...
public class StudentDetails {
	...
	public StudentDetails(String ethnicity, String religion, String country, String province, String districts,
	...
	public String toString() {
		return "StudentDetails [id=" + id + ", ethnicity=" + ethnicity + ", religion=" + religion + ", country="
