...
public class PrefixIdGeneratorDoanhNghiep implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        Long maxId = (Long) session.createQuery("select coalesce(max(id), :prefix) from DoanhNghiep")
